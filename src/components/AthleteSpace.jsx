...
export default function AthleteSpace({ currentUser, onLogout, managedSections=[] }) {
  ...
  const NAV=[{id:"dashboard",label:"Mon espace",icon:"*"},{id:"stats",label:"Mes stats",icon:"*"},{id:"crew",label:"Mon équipage",icon:"~"},{id:"boats",label:"Mon bateau",icon:"~"},{id:"planning",label:"Mon planning",icon:"#"},{id:"seances",label:"Mes séances",icon:"🏋️"},{id:"journal",label:"Journal",icon:"📓"},...(managedSections.length>0?[{id:"section",label:"Ma section",icon:"👥"}]:[])];
      ...
      {isMobile&&(
        <nav style={{position:"fixed",bottom:0,left:0,right:0,height:56,background:"#0f1923",borderTop:"1px solid #2d1b4e",display:"flex",zIndex:100}}>
          {NAV.map(n=>{
            ...
            const ICONS={dashboard:"🏠",stats:"📊",crew:"👥",boats:"⛵",planning:"📅",seances:"🏋️",journal:"📓",section:"🏅"};
            return(
